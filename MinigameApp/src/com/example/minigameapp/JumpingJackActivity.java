...
public class JumpingJackActivity extends Activity implements SensorEventListener{
	...
	public void onCreate(Bundle savedInstanceState){
	    ...
	    access.setJumpingJackActivity(this);
	...
	public void onSensorChanged(SensorEvent event){
		...
		public void keyPressed(KeyEvent e) {
		    if(e.getKeyCode() == KeyEvent.KEYCODE_NUMPAD_0){
		    	// assign directions
				float deltax=event.values[0];
				float deltay=event.values[1];
				float deltaz=event.values[2];
		    ...
		    if(e.getKeyCode() == KeyEvent.KEYCODE_NUMPAD_1){
		    	// assign directions
				float deltax=event.values[0];
				float deltay=event.values[1];
				float deltaz=event.values[2];
